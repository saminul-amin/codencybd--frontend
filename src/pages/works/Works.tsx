...
import {  Github, Eye, Code, ArrowRight } from "lucide-react";
  ...
  const projects = [
    {
      ...
      image:
        "https://i.ibb.co.com/PsCQnNLJ/photo-1460925895917-afdab827c52f.jpg",
      tags: ["React", "Tailwind CSS", "Framer Motion"],
      client: "Personal Project",
      duration: "1 week",
      year: "2025",
      status: "Live",
      liveUrl: "https://saminofolio.surge.sh/",
      githubUrl: "#",
    },
    {
      id: 2,
      ...
      category: "business",
      description:
        "This is a minimalistic library management web application built with React and TypeScript that demonstrates basic CRUD (Create, Read, Update, Delete) operations for managing library resources.",
      image: "https://i.ibb.co.com/Y7HpmWYc/library.png",
      tags: ["HTML5", "CSS3", "JavaScript", "Bootstrap"],
      client: "Personal Project",
      duration: "5 days",
      year: "2024",
      status: "Done",
      liveUrl: "https://library-management-client-kappa.vercel.app/",
      githubUrl: "https://github.com/saminul-amin/library-management-frontend",
    },
    {
      id: 3,
      ...
      image:
        "https://i.ibb.co.com/spHYkwsJ/photo-1611224923853-80b023f02d71.jpg",
      tags: ["React", "Drag and Drop (D&D)", "TailwindCSS"],
      client: "Learning Project",
      duration: "4 days",
      year: "2025",
      status: "Demo",
      liveUrl: "https://d-oh-list.web.app/",
      githubUrl: "https://github.com/saminul-amin/todo-list",
    },
    {
      id: 4,
      title: "Blogging Site",
      ...
      description:
        "Abu Aaisha's Blog is a personal platform dedicated to sharing authentic Islamic reminders, insights, and reflections upon the Qur'ān and Sunnah, based on the understanding of the Salaf-us-Sālih.",
      image: "https://i.ibb.co.com/GvxyCKDg/blogging.png",
      tags: ["React", "TailwindCSS", "Responsive Design"],
      client: "Learning Project",
      duration: "7 days",
      year: "2025",
      status: "Done",
      liveUrl: "https://abu-aaishas-blog.web.app/",
      githubUrl: "https://github.com/saminul-amin/abu-aaishas-blog",
    },
  ];
                  ...
                  <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0 ">
                    <div className="flex space-x-2">
                      <Link to={project.liveUrl} target="_blank">
                        <button className="flex items-center space-x-2 bg-white/90 dark:bg-slate-800/90 text-slate-900 dark:text-slate-100 px-4 py-2 rounded-lg text-sm font-medium hover:bg-white dark:hover:bg-slate-800 transition-colors z-10 cursor-pointer">
                          <Eye className="h-4 w-4" />
                          <span>View Live</span>
                        </button>
                      </Link>
                      <Link to={project.githubUrl} target="_blank">
                        <button className="flex items-center space-x-2 bg-slate-800/90 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-800 transition-colors z-10 cursor-pointer">
